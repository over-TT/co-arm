...
| 2026-09-04 | Camera/restart fixes and fresh-install release review completed | 767 Python tests plus 9 nested subtests, 197 dashboard tests and 42-module build, isolated installed-wheel smoke, disconnected browser smoke, 17 firmware host tests, six parsed scripts, plugin/skill checks, clean dependency audits, current 155-file manifest, and 232-file repository check | Physical recovery readiness, GitHub-hosted CI, deployment, Isaac runtime, device firmware build/flash, or fresh physical-arm proof |
