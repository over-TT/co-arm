...
| 2026-09-04 | Camera/restart fixes and fresh-install release review completed | 769 Python tests plus 9 nested subtests, 197 dashboard tests and 42-module build, isolated installed-wheel smoke, 44 manifest-matched wheel payloads, disconnected browser smoke, 17 firmware host tests, six parsed scripts, plugin/skill checks, clean dependency audits, current 155-file manifest, and 232-file repository check | Physical recovery readiness, GitHub-hosted CI, deployment, Isaac runtime, device firmware build/flash, or fresh physical-arm proof |
| 2026-09-05 | Live startup lifecycle and portable recovery hardened | 848 Python tests plus 9 subtests, 201 dashboard tests and 42-module build, new isolated wheel build and source-isolated package imports, 44 manifest-matched payloads, six parsed scripts, GNU-tar/Windows recovery regressions, current 159-file manifest and 236-file repository check | Physical Live responsiveness, replacement-Pi recovery, fresh dependency audits or firmware tests, deployment, or GitHub-hosted CI |
